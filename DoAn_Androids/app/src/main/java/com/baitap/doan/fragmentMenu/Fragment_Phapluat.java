...
public class Fragment_Phapluat extends Fragment implements LoaderManager.LoaderCallbacks<String> {
    //RecyclerView
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (loaderManager.getLoader(WEATHER_LOADER_ID) == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, data, Fragment_Phapluat.this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID, data, Fragment_Phapluat.this);
        }
        return  itemView;
    }
