...
public class Fragment_Xe extends Fragment implements LoaderManager.LoaderCallbacks<String> {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (loaderManager.getLoader(WEATHER_LOADER_ID) == null) {
            loaderManager.initLoader(WEATHER_LOADER_ID, data, Fragment_Xe.this);
        } else {
            loaderManager.restartLoader(WEATHER_LOADER_ID, data, Fragment_Xe.this);
        }
        return  itemView;
    }
